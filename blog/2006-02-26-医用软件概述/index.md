...
中国医院信息系统（CHISC/SV1.0）正是在这种形势下诞生的。CHIS的开发成功及在试点医院的成功运行，使其成为我国HIS研究、开发和应用的新里程碑，标志着我国医院计算机应用进入了一个新阶段——完整HIS的应用与推广阶段。CHIS的研制成功和实际应用与推广，使我国医院计算机应用水平与国际先进水平的差距至少缩短了数年。
