...
这篇文章的重点仍然是围绕初中的见闻和感悟。待儿子高中毕业，我再细述关于高中的更多体会。
...
- CE 课程（Concurrent Enrollment，双重注册课程， 也有学校称其为 Dual Enrollment 双学分课程）：属于大学程度课程，所获学分通常可被大学认可。这类课程的难度视具体科目而定，有些是给修完 AP 的学生提供的高阶课程（如高级数学）；也有一些是社区大学的基础课。但相较于 AP 课程，开设数量较少。
...
但莱克星顿高中却没有此类鼓励政策，不论 Honors 还是 AP 课程，成绩一律按原分数计算，不额外加权。这意味着，选修更高难度的课程，往往伴随着 GPA 下降的风险。不过，有的大学招生官在审核时，会根据学校提供的课程难度说明，重新评估或计算 GPA。尽管如此，在莱克星顿高中这种学霸云集的地方，如何在课程难度（Course Rigor）和漂亮的 GPA 数字之间寻找平衡，依然是一场高难度的博弈。
...
儿子的自然科学成绩一直不错，老师因此推荐他修读 Honors 课程。自然科学不像外语，没有跳级的选项，因为每个年级学习的科目不同：九年级（高一）- 地理；十年级（高二）- 生物；十一年级（高三）- 化学；十二年级（高四）- 物理。可以提前选后面的课程，比如十年级就学习物理，但前面的课程不能跳过不学。在国内，这四门课通常同时教授，而美国则采用分年级推进的方式。
