...
其中 $\vec{v}$ 为梳头方向向量， $\lambda_{\text{illusion}}$ 为视觉欺骗补偿项。
...
构建三维时空张量 $T∈ℝ^{1024×4096×24}$ ，引入流体动力学模型。我们将每一缕头发视为在头皮向量场中流动的非牛顿流体，计算其覆盖核心秃顶区域（Core Baldness Zone, CBZ）的最小代价路径。：
...
通过最大化该函数，我们成功引导自己和他人将注意力放在头发密集的区域，从而提高了在所有人主观感受中的头皮遮盖率。
